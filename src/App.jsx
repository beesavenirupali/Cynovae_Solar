...
const Divider = () => (
    <div className="w-full h-px bg-gradient-to-r from-transparent via-orange-500/30 to-transparent my-1"></div>
);
            ...
            <div className="container mx-auto px-8 py-4 flex items-center justify-between">
                ...
                <nav className="hidden lg:flex gap-3 xl:gap-5 font-bold text-[10px] xl:text-xs tracking-[0.1em] uppercase items-center">
                    ...
                    <div className="relative group">
                        <span className="text-slate-900 group-hover:text-orange-400 transition-colors cursor-pointer py-4 flex items-center gap-1">Services <svg className="w-3 h-3 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg></span>
                        <div className="absolute left-0 top-full -mt-2 w-56 bg-[#ffffff]/95 backdrop-blur-md border border-orange-500/20 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 flex flex-col z-50 py-2 shadow-2xl">
                            <a href="#sectors-apartments" className="text-slate-900 hover:text-orange-400 hover:bg-white/5 px-6 py-3 transition-colors">Residencial</a>
                            <a href="#sectors-commercial" className="text-slate-900 hover:text-orange-400 hover:bg-white/5 px-6 py-3 transition-colors">Commercial</a>
                            <a href="#sectors-apartments" className="text-slate-900 hover:text-orange-400 hover:bg-white/5 px-6 py-3 transition-colors">Housing Societies</a>
                            <a href="#solar-fencing" className="text-slate-900 hover:text-orange-400 hover:bg-white/5 px-6 py-3 transition-colors">Land</a>
                            <a href="#solar-care" className="text-slate-900 hover:text-orange-400 hover:bg-white/5 px-6 py-3 transition-colors">Maintenance Plan</a>
                        </div>
                    </div>

                    <a href="#solar-solutions" className="text-slate-900 hover:text-orange-400 transition-colors py-4 whitespace-nowrap">Solar Solutions</a>
            ...
            <AnimatePresence>
                {mobileMenuOpen && (
                    <motion.div
                        ...
                        className="lg:hidden absolute top-0 left-0 w-full h-screen bg-[#ffffff]/95 backdrop-blur-xl border-b border-orange-500/20 pt-24 px-8 pb-8 flex flex-col z-40 overflow-y-auto"
                    >
                        <nav className="flex flex-col gap-6 font-medium text-sm tracking-[0.2em] uppercase">
                            <a href="#hero" onClick={() => setMobileMenuOpen(false)} className="text-slate-500 hover:text-orange-400 transition-colors">Home</a>

                            <div className="flex flex-col gap-4">
                                <span className="text-slate-900">Services</span>
                                <div className="pl-4 border-l border-orange-500/20 flex flex-col gap-4">
                                    <a href="#sectors-apartments" onClick={() => setMobileMenuOpen(false)} className="text-slate-500 hover:text-orange-400 transition-colors text-xs">Residencial</a>
                                    <a href="#sectors-commercial" onClick={() => setMobileMenuOpen(false)} className="text-slate-500 hover:text-orange-400 transition-colors text-xs">Commercial</a>
                                    <a href="#sectors-apartments" onClick={() => setMobileMenuOpen(false)} className="text-slate-500 hover:text-orange-400 transition-colors text-xs">Housing Societies</a>
                                    <a href="#solar-fencing" onClick={() => setMobileMenuOpen(false)} className="text-slate-500 hover:text-orange-400 transition-colors text-xs">Land</a>
                                    <a href="#solar-care" onClick={() => setMobileMenuOpen(false)} className="text-slate-500 hover:text-orange-400 transition-colors text-xs">Maintenance Plan</a>
                                </div>
                            </div>
    ...
    return (
        <section id="hero" className="relative h-screen w-full overflow-hidden flex items-center justify-center">
            <motion.div style={{ y, opacity }} className="absolute inset-0 w-full h-[120%] -top-[10%] z-0">
                {/* Centered Sun */}
                <div className="absolute inset-0 bg-gradient-to-b from-white/20 via-transparent to-white z-20" />
                <div className="absolute inset-0 bg-white/10 z-10" />

                <img src="https://images.unsplash.com/photo-1509391366360-2e959784a276?q=80&w=2672&auto=format&fit=crop" className="w-full h-full object-cover object-center opacity-70" alt="Modern Solar Architecture" />
            </motion.div>
            ...
            <div className="absolute inset-0 z-20 pointer-events-none overflow-hidden">
                {particles.map((_, i) => (
                    <motion.div
                        ...
                        className="absolute w-1 h-1 bg-orange-400/50 rounded-full blur-[1px]"
                    />
                ))}
            </div>
            ...
            <div className="container mx-auto px-6 relative z-30 flex flex-col items-center text-center mt-32">
                <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 1.2, ease: "easeOut" }}>
                    ...
                    <h1 className="text-6xl md:text-[7rem] font-serif font-medium leading-[1.05] mb-8 text-slate-900 max-w-5xl mx-auto drop-shadow-2xl">
                        India's Energy Revolution <br /><span className="gold-gradient-text italic opacity-90 shimmer-text">Starts Here.</span>
                    </h1>
                    <p className="text-lg md:text-xl text-slate-500 max-w-2xl mx-auto leading-relaxed mb-12 font-light">
...
function Services() {
    ...
    return (
        <section id="services" className="py-12 relative z-10 w-full overflow-hidden">
            <Divider />
            <div className="container mx-auto px-6 relative z-10 mt-6">
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-12 text-center">
                    <span className="text-orange-500 font-sans tracking-[0.2em] text-xs uppercase mb-4 block">Our Offerings</span>
                    <h2 className="text-5xl md:text-7xl font-serif text-slate-900">Elite Infrastructure</h2>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    {services.map((svc, i) => (
                        <motion.div
                            ...
                            className="glass-dark p-12 rounded-none relative group transition-all duration-700 hover:-translate-y-2 border-t border-transparent hover:border-orange-500"
                        >
                            <div className="absolute inset-0 bg-gradient-to-b from-orange-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none"></div>
                            <div className="w-12 h-12 mb-10 flex items-center text-orange-500 opacity-60 group-hover:opacity-100 transition-opacity">
                            ...
                            <h3 className="text-3xl font-serif mb-6 text-slate-900">{svc.title}</h3>
                            <p className="text-slate-500 font-light leading-relaxed mb-10 group-hover:text-slate-900 transition-colors">{svc.desc}</p>
                            {/* Link Removed */}
                        </motion.div>
                    ))}
                </div>
...
function Impact() {
    ...
    return (
        <section id="impact" className="py-24 relative z-10 w-full flex justify-center overflow-hidden">
            <div className="absolute inset-0 z-0">
                <img src="https://images.unsplash.com/photo-1466611653911-954ffea113ad?q=80&w=2070&auto=format&fit=crop" className="w-full h-full object-cover opacity-[0.08]" alt="Environmental Impact" />
                <div className="absolute inset-0 bg-gradient-to-b from-white via-white/20 to-white"></div>
            </div>
            <div className="container mx-auto px-6 max-w-6xl relative z-10">
                <div className="text-center mb-16">
                    <h2 className="font-serif text-5xl md:text-7xl text-slate-900 mb-6">Global Impact Calculator</h2>
                    <p className="text-slate-500 max-w-2xl mx-auto font-light">Witness the empirical footprint reduction generated by our precision-engineered installations.</p>
                </div>

                <div className="glass-dark p-16 md:p-24 rounded-none relative overflow-hidden backdrop-blur-3xl">
                    <div className="absolute inset-0 z-0">
                        <img src="https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?q=80&w=2000&auto=format&fit=crop" className="w-full h-full object-cover opacity-20" alt="Solar Texture" />
                        ...
                        {Object.keys(systemData).map(key => (
                            <button
                                ...
                                className={`px-8 py-3 font-sans tracking-[0.1em] text-sm uppercase transition-all duration-500 border ${activeSystem === key
                                    ? 'bg-orange-500 text-black border-orange-500 shadow-[0_0_30px_rgba(249,115,22,0.4)]'
                                    : 'bg-transparent text-slate-500 border-neutral-800 hover:border-orange-500/50 hover:text-slate-900'
                                    }`}
                            >
                                {key}
                            </button>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-y-24 gap-x-8 relative">
                        <div className="hidden md:block absolute left-1/2 top-4 bottom-4 w-px bg-gradient-to-b from-transparent via-orange-500/20 to-transparent" />
                        <div className="hidden md:block absolute top-[50%] left-8 right-8 h-px bg-gradient-to-r from-transparent via-orange-500/20 to-transparent" />

                        <div className="text-center group">
                            <div className="text-7xl md:text-8xl font-serif text-slate-900 mb-6 tracking-tight shimmer-text">
                                <Counter to={data.trees} duration={1.2} />
                            </div>
                            <p className="text-sm tracking-[0.2em] text-orange-500 uppercase">Trees to the Planet</p>
                        </div>
                        ...
                        <div className="text-center group">
                            ...
                            <p className="text-sm tracking-[0.2em] text-orange-500 uppercase">Litres of Water Saved</p>
                        </div>

                        <div className="text-center group">
                            <div className="text-7xl md:text-8xl font-serif text-slate-900 mb-6 tracking-tight shimmer-text flex items-center justify-center gap-1">
                                <Counter to={data.co2} duration={1.2} decimals={1} />
                            </div>
                            <p className="text-sm tracking-[0.2em] text-orange-500 uppercase">Tons of CO<sub className="bottom-0">2</sub> Reduced</p>
                        </div>
                        ...
                        <div className="text-center group">
                            ...
                            <p className="text-sm tracking-[0.2em] text-orange-500 uppercase">Tons of Coal Avoided</p>
                        </div>
                    </div>
                </div>
            </div>
...
function Testimonials() {
    const testimonials = [
        { 
            name: "Ananya R.", 
            location: "Hyderabad", 
            title: "The attention to detail is unmatched.",
            text: "Living in a fast-paced city like Hyderabad, I usually expect services to be rushed. But these guys took their time and ensured everything was perfect. From the first consultation to the final result, the professionalism was 10/10. Definitely the best in the city!",
        ...
        { 
            ...
            text: "It’s hard to find someone who actually shows up on time and delivers exactly what they promised here in Karimnagar. I’m so glad I found this team. They were incredibly respectful of my home and the quality of work speaks for itself. Look at the photo—it looks even better in person!",
            image: "https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?q=80&w=1000&auto=format&fit=crop" 
        },
        { 
            name: "Karthik M.", 
            location: "Warangal", 
            title: "A total game-changer for us.",
            text: "We’ve tried a few different options in Warangal, but nothing compares to the quality we received here. They understood our requirements perfectly and handled the project with so much care. I’ve already recommended them to all my neighbors and family!",
        ...
        { 
            ...
            text: "I was a bit skeptical at first about whether I’d get the results I wanted, but I’m blown away. The team is hardworking, honest, and very skilled. It’s great to see such high-quality service available right here in Kamareddy. Truly worth every rupee.",
        ...
        { 
            ...
            text: "Finding top-tier service in Mancherial used to be a challenge, but not anymore. They were very communicative throughout the whole process and the finish is just flawless. If you’re on the fence, just go for it—you won't be disappointed.",
    ...
    return (
        <section id="testimonials" className="py-24 overflow-hidden relative z-10 w-full bg-slate-50/50">
            <Divider />
            <div className="container mx-auto px-6 mt-6 mb-16 text-center">
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                    <span className="text-orange-500 font-sans tracking-[0.2em] text-xs uppercase mb-4 block">Proven Results</span>
                    <h2 className="text-5xl md:text-7xl font-serif text-slate-900 leading-tight">
                        Real Homes. Real <span className="gold-gradient-text italic">Savings.</span>
                    </h2>
                </motion.div>
            </div>
            ...
            <div className="relative flex overflow-hidden group">
                ...
                >
                    {doubledTestimonials.map((t, i) => (
                        <div key={i} className="w-[320px] inline-block whitespace-normal">
                            <div className="bg-white border border-slate-100 shadow-xl rounded-3xl overflow-hidden h-full flex flex-col hover:shadow-2xl transition-all duration-500 group/card">
                                {/* Portrait Installation Photo at Top */}
                                <div className="h-[400px] w-full overflow-hidden relative">
                                    <img src={t.image} className="w-full h-full object-cover group-hover/card:scale-105 transition-transform duration-1000" alt="Installation Proof" />
                                    <div className="absolute top-4 right-4">
                                        <span className="bg-white/90 backdrop-blur-md text-slate-900 px-3 py-1 rounded-full text-[9px] font-bold tracking-widest shadow-md">
                                ...
                                <div className="p-8 flex flex-col flex-grow">
                                    <div className="flex items-center gap-1 mb-4">
                                        {[...Array(5)].map((_, star) => (
                                            <span key={star} className="text-orange-500 text-xs">★</span>
                                        ))}
                                    </div>
                                    
                                    <h4 className="font-serif text-lg text-slate-900 mb-3 leading-snug">{t.title}</h4>
                                    <p className="text-slate-500 text-sm font-light leading-relaxed mb-6 italic">
                                        "{t.text}"
                                    </p>

                                    <div className="mt-auto pt-6 border-t border-slate-50 flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-full overflow-hidden border border-orange-500/20">
                                            <img src={`https://ui-avatars.com/api/?name=${t.name}&background=f97316&color=fff&bold=true`} className="w-full h-full object-cover" alt={t.name} />
                                        </div>
                                        <div>
                                            <div className="font-serif text-md text-slate-900 leading-none mb-1">{t.name}</div>
                                            <div className="text-[9px] text-orange-500 tracking-widest uppercase font-semibold">{t.location}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
function OnGridDiagram() {
    return (
        <svg viewBox="0 0 500 280" className="w-full h-full" style={{ maxHeight: '260px' }}>
            ...
            {/* Inverter */}
            <rect x="210" y="170" width="80" height="36" rx="4" fill="rgba(249,115,22,0.12)" stroke="#ff8800" strokeWidth="1" />
            ...
            {/* House */}
            <polygon points="100,210 80,230 80,270 120,270 120,230" fill="rgba(249,115,22,0.08)" stroke="#ff8800" strokeWidth="1.5" />
            <polygon points="100,210 70,235 130,235" fill="rgba(249,115,22,0.12)" stroke="#ff8800" strokeWidth="1" />
...
function SystemLogic() {
    ...
    return (
        <section id="solar-solutions" className="py-12 relative z-10 w-full overflow-hidden">
            <Divider />
            <div className="container mx-auto px-6 mt-6">
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16 text-center">
                    <span className="text-orange-500 font-sans tracking-[0.2em] text-xs uppercase mb-4 block">System Architecture</span>
                    <h2 className="text-5xl md:text-7xl font-serif text-slate-900">System Logic</h2>
                    <p className="text-slate-400 mt-4 max-w-xl mx-auto font-light">Select your operating paradigm. Watch energy flow in real-time.</p>
                </motion.div>

                <div className="flex justify-center mb-12">
                    <div className="flex border border-orange-500/20" style={{ borderRadius: '2px' }}>
                ...
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        <div className="p-10 md:p-14 flex flex-col justify-center">
                            ...
                            <h3 className="font-serif text-4xl text-slate-900 mt-4 mb-2">{mode.tagline}</h3>
                            <p className="text-slate-500 font-light leading-relaxed mb-10">{mode.description}</p>
                            ...
                            <div className="grid grid-cols-3 gap-4 mb-10">
                                {mode.stats.map((s, i) => (
                                    <div key={i} className="text-center p-4" style={{ background: `${mode.color}08`, border: `1px solid ${mode.color}20` }}>
                                        ...
                                        <div className="text-xs text-slate-400 tracking-widest uppercase">{s.label}</div>
                                    </div>
                                ))}
                            </div>
        ...
        <section id="sectors" className="py-24 relative z-10 w-full overflow-hidden">
            ...
            <div className="container mx-auto px-6 mt-6">
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16">
                    <span className="text-orange-500 font-sans tracking-[0.2em] text-xs uppercase mb-4 block">Sector Intelligence</span>
                ...
                {/* Tab Toggle */}
                <div className="flex gap-0 mb-12 border border-orange-500/20 w-fit">
                        ...
                        <motion.div key="apartments" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.4 }}>
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                                ...
                                <div className="industrial-card p-10 relative overflow-hidden">
                                    ...
                                    <h3 className="font-serif text-4xl text-slate-900 mb-2 mt-4">Solar-Powered <span className="gold-gradient-text italic">Luxury Living</span></h3>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 mb-8">
                                        {[['Zero Common Area Bills', '☀️'], ['EV Charging Bays', '⚡'], ['24/7 Solar CCTV', '🔒'], ['Rooftop Gardens', '🌿']].map(([f, icon], i) => (
                                            <div key={i} className="flex items-center gap-3 p-3 rounded-sm" style={{ background: 'rgba(249,115,22,0.05)', border: '1px solid rgba(249,115,22,0.15)' }}>
                                                <span className="text-xl">{icon}</span>
                                                <span className="text-xs text-slate-900 tracking-wider">{f}</span>
                                            </div>
                                        ))}
                                    </div>
                                ...
                                <div className="industrial-card p-10 flex flex-col justify-between">
                                    <div>
                                        ...
                                        <h3 className="font-serif text-3xl text-slate-900 mt-4 mb-4">3D Amenity Tours & Resident Portal</h3>
                                        <p className="text-slate-500 font-light leading-relaxed mb-6">Walk through solar installations virtually before commitment. Residents access real-time energy dashboards, usage reports, and bill-split calculators through our exclusive portal.</p>
                                    </div>
                                    <div className="space-y-3">
                                        {[
                                            ...
                                            <div key={i} className="flex items-center gap-4 p-4 rounded-sm" style={{ background: 'rgba(249,115,22,0.04)', border: '1px solid rgba(249,115,22,0.12)' }}>
                            ...
                            {/* Stats Strip */}
                            <div className="bg-[#0f172a] p-8 grid grid-cols-2 md:grid-cols-4 gap-6 text-center border border-blue-500/20 shadow-xl relative overflow-hidden">
                                <div className="absolute inset-0 opacity-10" style={{ background: 'radial-gradient(circle at center, rgba(14,165,233,0.1) 0%, transparent 70%)' }} />
                                {[['₹0', 'Electricity Bills'], ['25Y', 'Performance Guarantee'], ['40%', 'Property Value Uplift'], ['100%', 'Common Area Coverage']].map(([v, l], i) => (
                                    <div key={i} className="relative z-10">
                                        ...
                                        <div className="text-[10px] md:text-xs text-slate-400 tracking-[0.2em] uppercase font-light">{l}</div>
                                    </div>
                                ))}
                            </div>
                        </motion.div>
                        ...
                        <motion.div key="commercial" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.4 }}>
                            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                                ...
                                <div className="lg:col-span-2 industrial-card p-10">
                                    ...
                                    <h3 className="font-serif text-4xl text-slate-900 mt-4 mb-4">Commercial Solar <span className="italic" style={{ color: '#ff9500' }}>Engineering</span></h3>
                                    <p className="text-slate-500 font-light leading-relaxed mb-8">
                                ...
                                <div className="industrial-card p-8 flex flex-col gap-6">
                                    <div>
                                        <span className="data-badge inline-block" style={{ color: '#ff8800', borderColor: 'rgba(249,115,22,0.3)', background: 'rgba(249,115,22,0.08)' }}>Lease Management</span>
                                        <h4 className="font-serif text-2xl text-slate-900 mt-4 mb-3">Zero-Hassle Lease Architecture</h4>
                                        <p className="text-slate-500 font-light leading-relaxed">We manage the full lease lifecycle — from structural assessment and grid approval to DISCOM synchronisation and lease exit protocols.</p>
                                    </div>
                                    <div className="space-y-3 flex-grow">
                                        {['DISCOM Grid Approval', 'Structural Load Report', '25-Year O&M SLA', 'Insurance Coverage', 'Performance Guarantee', 'Exit & Transfer Protocol'].map((item, i) => (
                                            <div key={i} className="flex items-center gap-3 text-xs text-slate-500 tracking-wider">
...
function SolarFencing() {
    ...
    return (
        <section id="solar-fencing" className="py-12 relative z-10 w-full overflow-hidden">
            <Divider />
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute inset-0" style={{ background: 'linear-gradient(180deg, transparent 0%, rgba(249,115,22,0.02) 50%, transparent 100%)' }} />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[400px]" style={{ background: 'radial-gradient(ellipse, rgba(249,115,22,0.04) 0%, transparent 70%)' }} />
            </div>
            <div className="container mx-auto px-6" ref={ref}>
                <motion.div initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.8 }} className="mb-16">
                    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
                        <div>
                            <span className="text-orange-500 font-sans tracking-[0.2em] text-xs uppercase mb-4 block">Land Intelligence</span>
                            <h2 className="text-5xl md:text-7xl font-serif text-slate-900 leading-none">
                                Solar Boundary<br /><span className="gold-gradient-text italic">Guarding</span>
                            </h2>
                        </div>
                        <div className="max-w-sm">
                            <p className="text-slate-400 font-light leading-relaxed md:text-right">The only perimeter that defends your land <em>and</em> pays for itself — converting every metre of fencing into a live energy asset.</p>
                        </div>
                    </div>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
                    <motion.div initial={{ opacity: 0, x: -40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.8, delay: 0.2 }}
                        ...
                        <h3 className="font-serif text-3xl text-slate-900 mt-4 mb-4">Physical Security. Legally Enforced.</h3>
                    ...
                    <motion.div initial={{ opacity: 0, x: 40 }} animate={inView ? { opacity: 1, x: 0 } : {}} transition={{ duration: 0.8, delay: 0.3 }}
                        ...
                        <h3 className="font-serif text-3xl text-slate-900 mt-4 mb-4">Your Fence Earns While It Guards.</h3>
                        <p className="text-slate-500 font-light leading-relaxed mb-6">
                ...
                <motion.div initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7, delay: 0.5 }}
                    className="bg-[#0f172a] p-8 grid grid-cols-2 md:grid-cols-4 gap-6 text-center border border-blue-500/30 shadow-2xl relative overflow-hidden">
                    <div className="absolute inset-0 opacity-15" style={{ background: 'radial-gradient(circle at center, rgba(14,165,233,0.15) 0%, transparent 70%)' }} />
...
function SolarCare({ setFormVisible }) {
    const ref = useRef(null);
    const inView = useInView(ref, { once: true, margin: '-60px' });

    return (
        <section id="solar-care" className="pt-24 pb-12 relative z-10 w-full overflow-hidden" ref={ref}>
            <Divider />
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[700px] h-[300px]" style={{ background: 'radial-gradient(ellipse, rgba(249,115,22,0.04) 0%, transparent 70%)' }} />
            </div>
            <div className="container mx-auto px-6 mt-6">
                <motion.div initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.8 }} className="mb-16">
                    <span className="text-orange-500 font-sans tracking-[0.2em] text-xs uppercase mb-4 block">Performance Recovery</span>
                    <h2 className="text-5xl md:text-7xl font-serif text-slate-900 leading-none">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
                    {[
                        ...
                        <motion.div key={i} initial={{ opacity: 0, y: 40 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.7, delay: i * 0.15 }}
                            ...
                            <h3 className="font-serif text-2xl text-slate-900 mt-4 mb-3">{s.title}</h3>
                ...
                <motion.div initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ delay: 0.6 }}
                    className="bg-[#0f172a] p-8 flex flex-col md:flex-row items-center justify-between gap-8 mb-10 border border-blue-500/30 shadow-2xl relative overflow-hidden">
                    <div className="absolute inset-0 opacity-10" style={{ background: 'radial-gradient(circle at center, rgba(14,165,233,0.1) 0%, transparent 70%)' }} />
                    ...
                    <button onClick={() => setFormVisible(true)} className="btn-luxury px-12 py-4 rounded-full font-bold text-sm tracking-[0.2em] uppercase flex-shrink-0 relative z-10">
                        📅 Book a Cleaning
                    </button>
                </motion.div>
            </div>
...
function CleaningModal({ onClose }) {
    ...
    const handleSubmit = async () => {
        if (formData.name && formData.phone) {
            ...
            try {
                ...
                data.append('message', formData.address);
    ...
    return (
        <motion.div key="cleaning-modal-overlay" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
            ...
            <motion.div initial={{ scale: 0.9, y: 30 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.9, y: 30 }}
                className="glass-dark w-full max-w-lg p-10 relative border border-orange-500/20">
                <button onClick={onClose} className="absolute top-5 right-5 text-slate-400 hover:text-orange-400 text-2xl transition-colors">×</button>
                {submitted ? (
                    <div className="text-center py-8">
                        <div className="text-5xl mb-4">✅</div>
                        <h3 className="font-serif text-3xl text-slate-900 mb-2">Booking Confirmed!</h3>
                        <p className="text-slate-500 text-sm">Our team will contact you shortly to schedule your cleaning visit.</p>
                    </div>
                ) : (
                    <>
                        <span className="data-badge mb-4 inline-block">Cleaning Enquiry</span>
                        <h3 className="font-serif text-3xl text-slate-900 mt-4 mb-6">Book a Solar Cleaning</h3>
                        <div className="space-y-4">
                            {[['Your Full Name', 'name', 'text'], ['Phone Number', 'phone', 'tel'], ['Installation Address', 'address', 'text'], ['Preferred Date', 'date', 'date']].map(([label, field, type]) => (
                                <div key={field}>
                                    <label className="text-xs text-slate-400 tracking-[0.2em] uppercase mb-2 block">{label}</label>
                                    <input type={type} value={formData[field]} onChange={e => setFormData({ ...formData, [field]: e.target.value })}
                                        ...
                                        className="w-full bg-transparent border border-orange-500/20 px-4 py-3 text-slate-900 text-sm focus:outline-none focus:border-orange-500/60 transition-colors placeholder:text-neutral-700 rounded-sm"
...
function WhyChooseUs() {
    ...
    const features = [
        ...
        {
            icon: "🛠️",
            title: "1-year maintenance promise",
    ...
    return (
        <section id="why-choose-us" className="pt-12 pb-24 relative z-10 w-full overflow-hidden" ref={ref}>
            <Divider />
            <div className="container mx-auto px-6 mt-6">
                <motion.div initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.8 }} className="mb-16">
                    <span className="text-orange-500 font-sans tracking-[0.2em] text-xs uppercase mb-4 block">The Cynova Advantage</span>
                    <h2 className="text-5xl md:text-6xl font-serif text-slate-900 leading-none max-w-3xl">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-8 items-center">
                    ...
                    <div className="space-y-8">
                        {features.map((feature, idx) => (
                            <motion.div
                                ...
                                className="flex gap-6 p-6 rounded-lg group hover:bg-white/[0.02] transition-colors border border-transparent hover:border-orange-500/20"
                            >
                                <div className="text-4xl text-orange-500 bg-orange-500/10 h-16 w-16 flex items-center justify-center rounded-sm shrink-0 border border-orange-500/20 group-hover:bg-orange-500/20 transition-colors">
                                    {feature.icon}
                                </div>
                                <div>
                                    <h3 className="text-2xl font-serif text-slate-900 mb-2">{feature.title}</h3>
                                    <p className="text-slate-500 font-light leading-relaxed mb-1">{feature.desc}</p>
                                    {feature.extra.map((line, i) => (
                                        <p key={i} className="text-slate-400 font-light leading-relaxed text-sm mt-2">
                                            {i === 0 ? <strong className="text-orange-400 font-medium">{line}</strong> : line}
                                        </p>
                                    ))}
                                </div>
                            </motion.div>
                    ...
                    {/* Right side: Structured Image Collage */}
                    <div className="relative h-[600px] w-full hidden lg:grid grid-cols-2 gap-4">
                        <motion.div
                            initial={{ opacity: 0, scale: 0.95 }}
                            whileInView={{ opacity: 1, scale: 1 }}
                            viewport={{ once: true }}
                            transition={{ duration: 0.8 }}
                            className="col-span-1 row-span-2 industrial-card overflow-hidden"
                        >
                            <img src="https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?q=80&w=1000&auto=format&fit=crop" alt="Modern Solar Array" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                        </motion.div>
                        <motion.div
                            ...
                            className="industrial-card overflow-hidden h-[290px]"
                        >
                            <img src="https://images.unsplash.com/photo-1613665813446-82a78c468a1d?q=80&w=1000&auto=format&fit=crop" alt="Installation" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                        </motion.div>
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            ...
                            className="industrial-card overflow-hidden h-[290px]"
                        >
                            <img src="https://images.unsplash.com/photo-1497435334941-8c899ee9e8e9?q=80&w=1000&auto=format&fit=crop" alt="Solar Field" className="w-full h-full object-cover hover:scale-105 transition-transform duration-700" />
                        </motion.div>
                    </div>
                </div>
            </div>
...
function WhyIndiaSolar() {
    const stats = [
        { value: "300+", label: "SUNNY DAYS A YEAR" },
        { value: "₹0", label: "ELECTRICITY BILLS" },
        { value: "25Y", label: "PERFORMANCE WARRANTY" }
    ];

    return (
        <section id="why-india" className="py-12 relative z-10 w-full overflow-hidden flex items-center justify-center min-h-[60vh] bg-[#030712]">
            <Divider />
            <div className="absolute inset-0 z-0">
                <img src="https://images.unsplash.com/photo-1509391366360-2e959784a276?q=80&w=2070&auto=format&fit=crop" className="w-full h-full object-cover opacity-30 grayscale mix-blend-luminosity" alt="India Solar Background" />
            ...
            <div className="relative z-10 w-full flex flex-col items-center justify-center text-center px-6">
                ...
                >
                    <h2 className="text-5xl md:text-7xl font-serif text-white leading-tight">
                        Why India Chooses <span className="gold-gradient-text italic">Solar</span>
                    </h2>
                </motion.div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 w-full max-w-6xl mx-auto">
                    {stats.map((stat, i) => (
                        <motion.div
                            key={i}
                        ...
                        >
                            <div className="text-6xl md:text-8xl font-serif gold-gradient-text mb-4 font-medium tracking-tight shimmer-text">
                                {stat.value}
                            </div>
                            <div className="w-12 h-px bg-orange-500/30 mb-6"></div>
                            <div className="text-[10px] md:text-xs tracking-[0.4em] text-neutral-400 font-light uppercase">
                                {stat.label}
                            </div>
                        </motion.div>
                    ))}
...
function FAQ() {
    ...
    const faqs = [
        {
            q: "What is Cynova solar?",
            a: "Cynova Solar is a solar EPC (Engineering, Procurement & Construction) company specializing in the design, installation, and maintenance of high-efficiency solar power systems for residencial and commercial customers."
        },
        {
            q: "How to apply for a Solar rooftop subsidy?",
            a: "Applying for a solar rooftop subsidy under the PM Surya Ghar Yojana is simple and hassle-free. First, register on the official portal and submit your application with your electricity details. Then, choose a registered vendor who will handle site survey, design, and installation after DISCOM approval, including net meter setup. Once the system is installed and inspected, you can apply for the subsidy, which will be directly credited to your bank account. Cynova Solar will guide you at every step and ensure you successfully receive your subsidy without any hassle."
        },
        {
        ...
        },
        {
            ...
            a: (
                <div className="space-y-4">
                    <p>No, solar installation is not complicated when handled by professionals. The entire process—from site survey and system design to approvals, installation, and testing—is managed by Cynova Solar.</p>
                    <p>For most homes, installation is completed within 1–3 days with minimal disruption to your routine. Cynova Solar ensures everything is done safely, neatly, and as per standards, making your transition to solar smooth and hassle-free.</p>
                </div>
            )
        },
        {
            q: "Post-Installation Support: What happens after installation?",
            a: "After your solar system is installed, Cynova Solar carries out complete testing to ensure everything is working perfectly. Our team provides a live demo and explains how the system functions, how to monitor your generation, and how to maximize your savings. We make sure you are fully comfortable and confident using your solar system before we hand it over."
        },
        {
            q: "What if your roof could pay your electricity bills for the next 25 years?",
            a: "With Cynova Solar, it can. By installing a smart solar system, you generate your own power, cut down up to 80–90% of your electricity costs, and enjoy reliable energy for decades—all from your rooftop."
        }
    ];
    ...
    return (
        <section id="faq" className="py-12 relative z-10 w-full overflow-hidden">
            <Divider />
            <div className="container mx-auto px-6 mt-6 max-w-4xl">
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="mb-16 text-center">
                    <span className="text-orange-500 font-sans tracking-[0.2em] text-xs uppercase mb-4 block">Knowledge Base</span>
                ...
                <div className="space-y-4">
                    {faqs.map((faq, idx) => (
                        <motion.div
                            ...
                            className="industrial-card rounded-md overflow-hidden border border-slate-100 hover:border-orange-500/30 transition-colors"
                        >
                            <button
                                onClick={() => toggleFaq(idx)}
                                className="w-full flex items-center justify-between p-6 text-left focus:outline-none"
                            >
                                <span className="font-serif text-lg text-slate-900 md:text-xl pr-4">{faq.q}</span>
                                <span className="text-orange-500 text-2xl font-light transform transition-transform duration-300" style={{ transform: openIndex === idx ? 'rotate(45deg)' : 'rotate(0deg)' }}>+</span>
                            </button>
                            <AnimatePresence>
                                {openIndex === idx && (
                                    <motion.div
                                    ...
                                    >
                                        <div className="p-6 pt-0 text-slate-500 font-light leading-relaxed border-t border-slate-100">
                                            {faq.a}
                                        </div>
                                    </motion.div>
                                )}
...
function App() {
    ...
    return (
        <main className="min-h-screen relative bg-[#ffffff] overflow-hidden selection:bg-orange-500 selection:text-white">
            ...
            <SectorSections />
            <SolarFencing />
            <SolarCare setFormVisible={setCleaningModal} />
            <FAQ />


            <footer className="relative pt-40 pb-12 overflow-hidden flex flex-col items-center border-t border-blue-500/20 bg-[#0f172a]">
                <div className="absolute inset-0 z-0">
                    <img src="https://images.unsplash.com/photo-1521618755572-156ae0cdd74d?q=80&w=2674&auto=format&fit=crop" className="w-full h-full object-cover object-bottom opacity-20" alt="Solar Background" />
                    <div className="absolute inset-0 bg-gradient-to-t from-[#0f172a] via-[#0f172a]/80 to-transparent"></div>
                </div>

                <div className="relative z-10 container mx-auto px-6 mb-10 text-center md:text-left">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
                        <div className="md:col-span-2">
                            ...
                            <div className="flex gap-4 mt-6">
                                {/* YouTube */}
                                <a href="https://www.youtube.com/@cynovaenergy" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-orange-500/30 flex items-center justify-center text-orange-500 hover:bg-orange-500/10 hover:border-orange-500 transition-all group">
                                ...
                                {/* Instagram */}
                                <a href="https://www.instagram.com/cynova.energy?igsh=MW1iZXlkZm1xeHE5OA==" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-orange-500/30 flex items-center justify-center text-orange-500 hover:bg-orange-500/10 hover:border-orange-500 transition-all group">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" className="group-hover:scale-110 transition-transform">
                        ...
                        <div>
                            <h4 className="text-orange-500 font-sans tracking-[0.2em] text-xs uppercase mb-6">Emails</h4>
                            <p className="text-slate-400 font-light leading-relaxed text-sm space-y-2">
                                <a href="mailto:info@cynovaenergy.com" className="block hover:text-white transition-colors">info@cynovaenergy.com</a>
                                <a href="mailto:hr@cynovaenergy.com" className="block hover:text-white transition-colors">hr@cynovaenergy.com</a>
                                <a href="mailto:ramakrishna@cynovaenergy.com" className="block hover:text-white transition-colors">ramakrishna@cynovaenergy.com</a>
                            </p>
                        </div>

                        <div>
                            <h4 className="text-orange-500 font-sans tracking-[0.2em] text-xs uppercase mb-6">Contact us</h4>
                            <p className="text-slate-400 font-light leading-relaxed text-sm space-y-2">
                                <a href="tel:+918179855959" className="block hover:text-white transition-colors">+91 81798 55959</a>
                                <a href="tel:+917680953888" className="block hover:text-white transition-colors">+91 76809 53888</a>
                            </p>
                        </div>
                    </div>
                </div>

                <div className="relative z-10 container mx-auto px-6 flex flex-col md:flex-row items-center justify-between pt-8 border-t border-slate-800 text-center md:text-left">
                    <p className="text-xs text-slate-500 tracking-[0.2em] uppercase mb-4 md:mb-0">© {new Date().getFullYear()} Cynova Energy Corp. All Rights Reserved.</p>
                    <div className="flex gap-6 text-xs text-slate-500 tracking-[0.1em] uppercase justify-center">
                        <button onClick={() => setLegalModal('privacy')} className="hover:text-white transition-colors uppercase tracking-[0.1em]">Privacy Policy</button>
                        <button onClick={() => setLegalModal('terms')} className="hover:text-white transition-colors uppercase tracking-[0.1em]">Terms of Service</button>
                    </div>
                </div>
            </footer>
                ...
                {legalModal && (
                    <motion.div key="legal-modal" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}
                        ...
                        <motion.div initial={{ scale: 0.95, y: 20 }} animate={{ scale: 1, y: 0 }} exit={{ scale: 0.95, y: 20 }}
                            className="glass-dark w-full max-w-4xl max-h-[85vh] overflow-y-auto p-10 relative border border-orange-500/20 text-slate-900">
                            <button onClick={() => setLegalModal(null)} className="absolute top-6 right-6 text-slate-400 hover:text-orange-400 text-3xl transition-colors leading-none">&times;</button>

                            {legalModal === 'privacy' && (
                                <div className="space-y-6 text-sm font-light leading-relaxed pr-4">
                                    <h2 className="text-3xl font-serif text-slate-900 mb-8 border-b border-slate-200 pb-4">Privacy & Whistleblower Policy</h2>
                                    ...
                                    <ul className="list-none space-y-2">
                                        <li><span className="text-orange-500 mr-2">a)</span>Fraud (an act of willful misrepresentation which would affect the interests of the concerned) against investors, securities fraud, mail or wire fraud, bank fraud, or fraudulent statements to relevant authority;</li>
                                        <li><span className="text-orange-500 mr-2">b)</span>general malpractice - such as immoral, illegal or unethical conduct;</li>
                                        <li><span className="text-orange-500 mr-2">c)</span>gross misconduct;</li>
                                        <li><span className="text-orange-500 mr-2">d)</span>potential infractions of the Company's internal controls;</li>
                                        <li><span className="text-orange-500 mr-2">e)</span>potential infractions of the requirements in, or made under, the regulations of the relevant countries where the Company operates;</li>
                                        <li><span className="text-orange-500 mr-2">f)</span>potential infractions of the codes of conduct of all relevant professional institutions; and</li>
                                        <li><span className="text-orange-500 mr-2">g)</span>any other event which would affect the interests of the business.</li>
                                    </ul>

                                    <h3 className="text-xl text-slate-900 mt-8 mb-4 border-l-2 border-orange-500 pl-4">1. Specific objectives of the policy shall include:</h3>
                                    <ul className="list-none space-y-2">
                                        <li><span className="text-orange-500 mr-2">a)</span>to encourage timely reporting of alleged malpractices/misconduct;</li>
                                        <li><span className="text-orange-500 mr-2">b)</span>to provide a means of discreet and confidential channel for escalation of concerns without fear of reprisal;</li>
                                        <li><span className="text-orange-500 mr-2">c)</span>to ensure consistence and timely responses to reported impropriety and awareness by whistleblowers of their obligations/rights;</li>
                                        <li><span className="text-orange-500 mr-2">d)</span>to serve as a means of preventing and deterring misconduct that may be contemplated but has not yet taken place; and</li>
                                        <li><span className="text-orange-500 mr-2">e)</span>to protect the rights of the Authority and its stakeholders.</li>
                                    </ul>

                                    <h3 className="text-xl text-slate-900 mt-8 mb-4 border-l-2 border-orange-500 pl-4">2. Types of Whistleblowing</h3>
                                    <div className="space-y-4">
                                        <div>
                                            <strong className="text-slate-900 block mb-1">2.1 Internal Whistleblowers:</strong>
                                        ...
                                        <div>
                                            <strong className="text-slate-900 block mb-1">2.2 External Whistleblowers:</strong>
                                    ...
                                    <h3 className="text-xl text-slate-900 mt-8 mb-4 border-l-2 border-orange-500 pl-4">3. Procedure:</h3>
                                    <ul className="space-y-4 list-none">
                                        <li className="flex"><span className="text-orange-500 mr-3 font-bold">a)</span><span>The Whistleblower should promptly report the suspected or actual event to his/her supervisor.</span></li>
                                        <li className="flex"><span className="text-orange-500 mr-3 font-bold">b)</span><span>If the Whistleblower would be uncomfortable or otherwise reluctant to report to his/her supervisor, then the Whistleblower could report the event to the next highest or another level of management, including to an appropriate Board committee or member.</span></li>
                                        <li className="flex"><span className="text-orange-500 mr-3 font-bold">c)</span><span>The Whistleblower can report the event with his/her identity or anonymously.</span></li>
                                        <li className="flex"><span className="text-orange-500 mr-3 font-bold">d)</span><span>The Whistle blower shall receive no retaliation or retribution for a report that was provided in good faith – that was not done primarily with malice to damage another or the organization.</span></li>
                                        <li className="flex"><span className="text-orange-500 mr-3 font-bold">e)</span><span>A Whistleblower who makes a report that is not done in good faith is subject to disciplinary action, including termination or other legal means to protect the reputation of the organization and members of its Board and staff.</span></li>
                                        <li className="flex"><span className="text-orange-500 mr-3 font-bold">f)</span><span>Anyone who retaliates against the Whistleblower (who reported an event in good faith) will be subject to discipline, including termination of Board or Employee status.</span></li>
                                        <li className="flex"><span className="text-orange-500 mr-3 font-bold">g)</span><span>Crimes against persons or property should immediately be reported to the local police department.</span></li>
                                        <li className="flex"><span className="text-orange-500 mr-3 font-bold">h)</span><span>Supervisors, managers and/or board members who receive the reports must promptly act to investigate and/or resolve the issue.</span></li>
                                        <li className="flex"><span className="text-orange-500 mr-3 font-bold">i)</span><span>The Whistleblower shall receive an acknowledgement and a plan of action within 7 working days of the initial report, regarding the investigation, disposition or resolution of the issue.</span></li>
                                    </ul>
                                    <div className="mt-8 p-4 bg-white/5 border border-slate-200 rounded-sm">
                            ...
                            {legalModal === 'terms' && (
                                <div className="space-y-6 text-sm font-light leading-relaxed pr-4">
                                    <h2 className="text-3xl font-serif text-slate-900 mb-8 border-b border-slate-200 pb-4">Terms of Service</h2>

                                    <h3 className="text-xl text-slate-900 mt-6 mb-3 border-l-2 border-orange-500 pl-4">Terms of Use</h3>
                                    ...
                                    <h3 className="text-xl text-slate-900 mt-6 mb-3 border-l-2 border-orange-500 pl-4">Refund Policy</h3>
                                    <p className="mb-6">The advance payment is non-refundable under any circumstances.</p>

                                    <h3 className="text-xl text-slate-900 mt-6 mb-3 border-l-2 border-orange-500 pl-4">Shipping & Project Timeline</h3>
            ...
            <AnimatePresence>
                {cleaningModal && (
                    <CleaningModal onClose={() => setCleaningModal(false)} />
                )}
            </AnimatePresence>
            <WhatsAppButton />
        </main>
...
function WhatsAppButton() {
    return (
        <motion.a
            href="https://wa.me/919951696888?text=Hi%20Cynova%20Energy,%20I%20am%20interested%20in%20a%20solar%20system."
            target="_blank"
            ...
            whileTap={{ scale: 0.9 }}
            className="fixed bottom-8 right-8 z-[9999] flex items-center justify-center w-16 h-16 bg-[#25D366] rounded-full shadow-[0_10px_25px_rgba(37,211,102,0.4)] transition-all duration-300 group"
        >
